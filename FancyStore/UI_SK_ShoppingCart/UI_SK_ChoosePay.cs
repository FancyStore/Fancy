    ...
    public partial class UI_SK_ChoosePay : UI_SK_MotherForm
    {
        public UI_SK_ChoosePay()
        {
            ...
            for (int i =0;i<= Cls_Utility.Class1.CartList.Count - 1; i++)
            {
                ...
                b.SmallSum = 0;
                Cls_SK_NormalClass.ShoppingList.Add(b);
                Cls_SK_NormalClass.ShoppingList[i].SmallSum = (int)(Cls_Utility.Class1.CartList[i].Qty
                    * Cls_Utility.Class1.CartList[i].UnitPrice);
            }
            #endregion 小計
        }
        ...
        internal void UI_SK_CP_PM_Name1_lbl_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Cls_SK_NormalClass.UI_SK_CP_PM_SQL = dbContext_FSE.PayMethods.Where(sh => sh.PayMethodID == 1)
                .Select(sh => sh.PayMethodID).FirstOrDefault();
        }
        ...
        internal void UI_SK_CP_PM_Name2_lbl_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Cls_SK_NormalClass.UI_SK_CP_Way_Bool_RB3 = false;
            Cls_SK_NormalClass.UI_SK_CP_Way_Bool_RB4 = false;
            Cls_SK_NormalClass.UI_SK_CP_PM_SQL = dbContext_FSE.PayMethods.Where(sh => sh.PayMethodID == 2).Select(sh => sh.PayMethodID).FirstOrDefault();
        }
        ...
        internal void UI_SK_CP_PM_Name3_lbl_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Cls_SK_NormalClass.UI_SK_CP_Way_Bool_RB4 = false;
            Cls_SK_NormalClass.UI_SK_CP_PM_SQL = dbContext_FSE.PayMethods.Where(sh => sh.PayMethodID == 3).Select(sh => sh.PayMethodID).FirstOrDefault();
        }
        ...
        internal void UI_SK_CP_PM_Name4_lbl_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Cls_SK_NormalClass.UI_SK_CP_PM_SQL = dbContext_FSE.PayMethods.Where(sh => sh.PayMethodID == 4).Select(sh => sh.PayMethodID).FirstOrDefault();
        }
